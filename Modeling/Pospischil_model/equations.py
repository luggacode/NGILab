...
# I_inj_mod                                       : 1
# I_inj= I_max * TimedArray(t)                   : amp/meter**2
# I_inj = I_ramp/T_ramp * (t - 0.1*second) * TimedArray(t)                      : amp/meter**2
# dI_noise/dt = mask_noise * sigma_noise * sqrt(c_m/g_noise_L) * xi/second           : amp/meter**2

    if model == 'hh-neuron':
        eqs += Equations('''
            I_Na = g_Na*m**3*h*(v-E_Na)                       : amp/meter**2
            I_Kd = g_Kd*n**4*(v-E_K)                               : amp/meter**2
            I_M = g_M*p*(v-E_K)                               : amp/meter**2
        ...
        eqs += Equations('''
            ...
            E_AMPA = -50 * mvolt                  : volt
            E_GABA = -100 *mvolt                            : volt
...
# + I_noise
        ...
        eqs += Equations('''
            ...
            Check_2 = I_Kd + I_M + I_K_L - 2 * I_NKP - I_KCC                   :amp/meter**2
    ...
    ## CURRENTLY WITHOUT I_NOISE
        ...
        eqs += Equations('''
            ...
            I_NKP = I_NKP_max * f_NaK * Hill(C_Na_N, zeta_Na, 1.5) * Hill(C_K_E, zeta_K, 1) : amp/meter**2
            I_KCC = g_KCC*(E_K - E_Cl)                          : amp/meter**2           
            dv/dt=(I_inj - I_Na - I_Na_L - I_Kd - I_M - I_K_L - I_Cl_L - I_NKP - I_syn)/c_m       : volt
            g_syn_e                               : siemens/meter**2 
            g_syn_i                               : siemens/meter**2 
            E_AMPA = - 50 * mvolt                   : volt 
            E_GABA = -100 *mvolt                            : volt

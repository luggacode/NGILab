...
//////////////// clocks ///////////////////
extern Clock hh_clock;
extern Clock svmon_clock;
...
extern int32_t *_array_hh__spikespace;
extern const int _num__array_hh__spikespace;
extern double *_array_hh_clock_dt;
extern const int _num__array_hh_clock_dt;
extern double *_array_hh_clock_t;
extern const int _num__array_hh_clock_t;
extern int64_t *_array_hh_clock_timestep;
extern const int _num__array_hh_clock_timestep;
extern double *_array_hh_h;
extern const int _num__array_hh_h;
extern int32_t *_array_hh_i;
extern const int _num__array_hh_i;
extern double *_array_hh_m;
extern const int _num__array_hh_m;
extern double *_array_hh_n;
extern const int _num__array_hh_n;
extern double *_array_hh_n_Cl_E;
extern const int _num__array_hh_n_Cl_E;
extern double *_array_hh_n_Cl_N;
extern const int _num__array_hh_n_Cl_N;
extern double *_array_hh_n_K_E;
extern const int _num__array_hh_n_K_E;
extern double *_array_hh_n_K_N;
extern const int _num__array_hh_n_K_N;
extern double *_array_hh_n_Na_E;
extern const int _num__array_hh_n_Na_E;
extern double *_array_hh_n_Na_N;
extern const int _num__array_hh_n_Na_N;
extern double *_array_hh_v;
extern const int _num__array_hh_v;
...
extern double *_array_svmon_clock_dt;
extern const int _num__array_svmon_clock_dt;
extern double *_array_svmon_clock_t;
extern const int _num__array_svmon_clock_t;
extern int64_t *_array_svmon_clock_timestep;
extern const int _num__array_svmon_clock_timestep;
extern double *_array_svmon_E_Cl;
extern const int _num__array_svmon_E_Cl;
extern double *_array_svmon_I_Cl;
extern const int _num__array_svmon_I_Cl;
...
extern DynamicArray2D<double> _dynamic_array_svmon_I_Cl;

#include "code_objects/hh_spike_resetter_codeobject.h"
#include "objects.h"
...
void _run_hh_spike_resetter_codeobject()
{
...
const size_t _num_spikespace = 2;
    ...
    int32_t* __restrict  _ptr_array_hh__spikespace = _array_hh__spikespace;



	const int32_t *_events = _ptr_array_hh__spikespace;
	const int32_t _num_events = _ptr_array_hh__spikespace[N];

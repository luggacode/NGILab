...
const double v_thr = false;
    ...
    int32_t* __restrict  _ptr_array_hh_1__spikespace = _array_hh_1__spikespace;
    ...
    for(size_t _idx=0; _idx<N; _idx++)
    {
        ...
        const double v = _ptr_array_hh_1_v[_idx];
        const char _cond = v > v_thr;

        if(_cond) {
            _ptr_array_hh_1__spikespace[_count++] = _idx;
        }
    }
    _ptr_array_hh_1__spikespace[N] = _count;

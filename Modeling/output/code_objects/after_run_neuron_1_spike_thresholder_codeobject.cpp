#include "objects.h"
#include "code_objects/after_run_neuron_1_spike_thresholder_codeobject.h"
...
const size_t _numv = 1;
    ...
    int32_t* __restrict  _ptr_array_neuron_1__spikespace = _array_neuron_1__spikespace;
    double*   _ptr_array_neuron_1_v = _array_neuron_1_v;

_ptr_array_neuron_1__spikespace[N] = 0;  // Note that this is not an off-by-1-error: the array has N+1 elements
